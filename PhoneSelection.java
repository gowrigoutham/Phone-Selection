...
public class PhoneSelection{
	public static void main(String [] args){
		...
		**************************************************/
			System.out.print("The digit " + 2 + " corresponds to the letter " + letter + " on the telephone");
		}
			else if (letter == 'D' || letter == 'E'  || letter == 'F' ){
		/*
		* print/output the digit 3 that corresponds to the letterInput of D E F 
		********************************************** */
				System.out.print("The digit " + 3 + " corresponds to the letter " + letter + " on the telephone");
		}
				else if (letter == 'G'  || letter == 'H' || letter == 'I' ){
		/*
		* print/output the digit 4 that corresponds to the letterInput of G H K
		***********************************************/
					System.out.print("The digit " + 4 + " corresponds to the letter " + letter + " on the telephone");
		}
					else if (letter == 'J'  || letter == 'K'  || letter == 'L' ){
		/*
		* print/output the digit 5 that corresponds to the letterInput of J H K L
		************************************************/
						System.out.print("The digit " + 5 + " corresponds to the letter " + letter + " on the telephone"); 
		}
						else if (letter == 'M' || letter == 'N' || letter == 'O'){
		/*
		* print/output the digit 6 that corresponds to the letterInput of M N O
		**************************************************/
							System.out.print("The digit " + 6 + " corresponds to the letter " + letter + " on the telephone");
		}
							else if (letter == 'P' || letter == 'Q' || letter == 'R' || letter == 'S'){
		/*
		* print/output the digit 7 that corresponds to the letterInput of P Q R S 
		***********************************************/
								System.out.print("The digit " + 7 + " corresponds to the letter " + letter + " on the telephone");
		}
								else if (letter == 'T' || letter == 'U' || letter == 'V'){
		/*
		* print/output the digit 8 that corresponds to the letterInput of T U V
		*************************************************/
									System.out.print("The digit " + 8 + " corresponds to the letter " + letter + " on the telephone");
		}
									else if (letter == 'W' || letter == 'X' || letter == 'Y' || letter == 'Z'){
		/*
		* print/output the digit 9 that corresponds to the letterInput of W X Y Z
		*************************************************/
										System.out.print("The digit " + 9 + " corresponds to the letter " + letter + " on the telephone");
		}
